...
public class When_simulating_handler_emitted_send : NServiceBusAcceptanceTest
{
    [Test]
    ...
    public class Context : ScenarioContext
    {
        ...
        public void MaybeCompleted() => MarkAsCompleted(HandlerEmittedSendCount >= 2);
    }
    ...
    public class Endpoint : EndpointConfigurationBuilder
    {
        ...
        [Handler]
        public class StartHandler : IHandleMessages<StartMessage>
        {
        ...
        [Handler]
        public class SendHandler(Context testContext, FakeTimeProvider simulatedTime) : IHandleMessages<HandlerEmittedSendMessage>
        {
