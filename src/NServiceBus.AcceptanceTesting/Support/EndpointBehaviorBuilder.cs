    ...
    where TContext : ScenarioContext
{
    ...
    public EndpointBehaviorBuilder<TContext> ServiceResolve(Func<IServiceProvider, CancellationToken, Task> action, bool afterStart = false)
    {
    ...
    public EndpointBehaviorBuilder<TContext> ToCreateInstance<T>(Func<IServiceCollection, EndpointConfiguration, Task<T>> createCallback, Func<T, IServiceProvider, CancellationToken, Task<IStoppableEndpointInstance>> startCallback)
        where T : notnull
    {
    ...
    public EndpointBehaviorBuilder<TContext> ToCreateInstance<T>(Func<IServiceCollection, EndpointConfiguration, T> createCallback, Func<T, IServiceProvider, CancellationToken, Task<IStoppableEndpointInstance>> startCallback)
        where T : notnull
    {
