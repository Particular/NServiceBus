...
public class AddHandlerGeneratorTests
{
    ...
    [Test]
    public void ConventionBasedHandlerWithOnlyPrivateConstructorProducesNoRegistration()
    {
        var source = """
                     using System.Threading.Tasks;
                     using NServiceBus;
                     ...
                     public class Test
                     {
                         public void Configure(EndpointConfiguration cfg)
                         {
                             cfg.Handlers.ConventionBasedHandlerWithOnlyPrivateConstructorProducesNoRegistrationAssembly.AddAll();
                         }
                     }
    ...
    public void ConventionBasedHandlerWithKeyedServices()
    {
        var source = """
                     ...
                     public class Test
                     {
                         public void Configure(EndpointConfiguration cfg)
                         {
                             cfg.Handlers.ConventionBasedHandlerWithKeyedServicesAssembly.AddAll();
                         }
                     }
    ...
    public void ConventionBasedHandlerWithKeyedServicesInAnotherNamespace()
    {
        var source = """
                     ...
                     public class Test
                     {
                         public void Configure(EndpointConfiguration cfg)
                         {
                             cfg.Handlers.ConventionBasedHandlerWithKeyedServicesInAnotherNamespaceAssembly.AddAll();
                         }
                     }
