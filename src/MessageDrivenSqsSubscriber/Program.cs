namespace MessageDrivenSqsSubscriber
{
    using System;
    ...
    class Program
    {
        ...
        {
            Console.Title = "MessageDrivenSqsSubscriber";
            #region ConfigureEndpoint

            var endpointConfiguration = new EndpointConfiguration("MessageDrivenSqsSubscriber");
