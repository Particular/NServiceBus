...
public sealed class AssemblyScanningGenerator : IIncrementalGenerator
{
    ...
    static readonly ImmutableArray<GeneratedRegistrationClass> RegistrationMethodsByConvention =
    [
        new("NServiceBus.Generated.GeneratedTypeRegistrations"),
    ];
    ...
    static void GenerateInterceptorCode(SourceProductionContext sourceProductionContext, InterceptorsAndRegistrationClasses data)
    {
        ...
        if (useSourceGenMethods.Any())
        {
            ...
            {
                sb.AppendLine($"            {method.ClassName}.RegisterRequiredTypes(endpointConfiguration);");
            }
        ...
        if (registerHandlersMethods.Any())
        {
            ...
            foreach (var method in regClasses)
            {
                sb.AppendLine($"            {method.ClassName}.RegisterOptionalTypes(options.Configuration);");
            }
