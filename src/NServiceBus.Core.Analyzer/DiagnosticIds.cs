...
#endif
{
    ...
    public const string SagaAttributeMissing = "NSB0025";
    public const string SagaAttributeMisplaced = "NSB0026";
    public const string SagaAttributeOnNonSaga = "NSB0027";

    // HandlerRegistrationsExtensionsAttributeAnalyzer
    public const string MultipleHandlerRegistryExtensions = "NSB0028";
    public const string HandlerRegistryExtensionsMustBePartial = "NSB0029";
