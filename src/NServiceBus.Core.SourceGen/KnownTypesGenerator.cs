...
public sealed class KnownTypesGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        var collectedSourceMarkers = markersFromSourceAttributes.Where(m => m.Diagnostic is null).Collect();
        var collectedCompilationMarkers = markersFromCompilationAttributes.Where(m => m.Diagnostic is null).Collect();
        var collectedBuiltInMarkers = builtInMarkers.Where(m => m.Diagnostic is null).Collect();
