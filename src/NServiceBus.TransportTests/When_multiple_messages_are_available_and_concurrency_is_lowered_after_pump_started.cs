...
public class When_multiple_messages_are_available_and_concurrency_is_lowered_after_pump_started : NServiceBusTransportTest
{
    [TestCase(TransportTransactionMode.None)]
    [TestCase(TransportTransactionMode.ReceiveOnly)]
    [TestCase(TransportTransactionMode.SendsAtomicWithReceive)]
    [TestCase(TransportTransactionMode.TransactionScope)]
    public async Task Fewer_messages_handled_concurrently(TransportTransactionMode transactionMode)
    {
