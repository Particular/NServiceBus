namespace NServiceBus
{
    ...
    class DispatchTimeoutBehavior : SatelliteBehavior
    {
        ...
        protected override async Task Terminate(PhysicalMessageProcessingStageBehavior.Context context)
        {
            ...
            await dispatcher.Dispatch(new[] { new TransportOperation(new OutgoingMessage(message.MessageId, timeoutData.Headers, timeoutData.Body), sendOptions) }, context).ConfigureAwait(false);
        }
