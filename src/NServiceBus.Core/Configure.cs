namespace NServiceBus
{
    ...
    public partial class Configure
    {
        ...
        static void EnsureThisCodeIsNotBeingCalledFromIConfigureThisEndpoint()
        {
            ...
            if (targetFrame != null)
            {
                throw new InvalidOperationException("Do not call Configure.With from IConfigureThisEndpoint.Customize. Instead use the \"builder\" argument passed to the Customize method and/or the INeedInitialization interface.");
            }
        }
