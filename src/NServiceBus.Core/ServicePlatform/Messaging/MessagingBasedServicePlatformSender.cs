...
class MessagingBasedServicePlatformSender<TMessage> : ServicePlatformSender<TMessage>
{
    ...
    public override async Task Send(TMessage message, CancellationToken cancellationToken = default)
    {
