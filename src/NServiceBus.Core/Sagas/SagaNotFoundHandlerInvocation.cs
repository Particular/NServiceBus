...
sealed class SagaNotFoundHandlerInvocation<[DynamicallyAccessedMembers(DynamicMemberTypeAccess.SagaNotFoundHandler)] TSagaNotFoundHandler> : ISagaNotFoundHandlerInvocation where TSagaNotFoundHandler : ISagaNotFoundHandler
{
