...
public sealed class Sagas : Feature
{
    ...
    protected override void Setup(FeatureConfigurationContext context)
    {
        ...
        context.Pipeline.Register("InvokeSaga", b => new SagaPersistenceBehavior(b.GetRequiredService<ISagaPersister>(), sagaIdGenerator, sagaMetaModel, b, b.GetRequiredService<PipelineMetrics>()), "Invokes the saga logic");
