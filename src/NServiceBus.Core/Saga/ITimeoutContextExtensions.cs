namespace NServiceBus.Saga
{
    ...
    /// </summary>
    public static class ITimeoutContextExtensions
    {
        /// <summary>
        ...
        public static void SendLocal(this ITimeoutContext context, object message)
        {
        ...
        public static void SendLocal<T>(this ITimeoutContext context, Action<T> messageConstructor)
        {
            Guard.AgainstNull(context, "context");
        ...
        public static void Publish(this ITimeoutContext context, object message)
        {
        ...
        public static void Publish<T>(this ITimeoutContext context)
        {
        ...
        /// <param name="context">Object beeing extended</param>
        /// <param name="messageConstructor">An action which initializes properties of the message</param>
        public static void Publish<T>(this ITimeoutContext context, Action<T> messageConstructor)
        {
        ...
        /// <param name="context">Object beeing extended</param>
        /// <param name="message">The message to send.</param>
        public static void Send(this ITimeoutContext context, object message)
        {
        ...
        /// </remarks>
        public static void Send<T>(this ITimeoutContext context, Action<T> messageConstructor)
        {
            Guard.AgainstNull(context, "bus");
            Guard.AgainstNull(messageConstructor, "messageConstructor");
        ...
        /// </param>
        /// <param name="message">The message to send.</param>
        public static void Send(this ITimeoutContext context, string destination, object message)
        {
            Guard.AgainstNull(context, "bus");
        ...
        /// <param name="messageConstructor">An action which initializes properties of the message</param>
        public static void Send<T>(this ITimeoutContext context, string destination, Action<T> messageConstructor)
        {
            Guard.AgainstNull(context, "bus");
            Guard.AgainstNullAndEmpty(destination, "destination");
            Guard.AgainstNull(messageConstructor, "messageConstructor");
