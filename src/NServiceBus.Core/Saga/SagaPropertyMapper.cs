namespace NServiceBus.Saga
{
    ...
    public class SagaPropertyMapper<TSagaData> where TSagaData : IContainSagaData
    {
        ...
        /// <returns>A <see cref="ToSagaExpression{TSagaData,TMessage}"/> that provides the fluend chained <see cref="ToSagaExpression{TSagaData,TMessage}.ToSaga"/> to link <paramref name="messageProperty"/> with <see cref="TSagaData"/>.</returns>
