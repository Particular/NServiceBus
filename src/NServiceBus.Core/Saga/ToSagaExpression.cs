namespace NServiceBus.Saga
{
    ...
    public class ToSagaExpression<TSagaData, TMessage> where TSagaData : IContainSagaData
    {
        ...
        {
            Guard.AgainstDefault(sagaMessageFindingConfiguration, "sagaMessageFindingConfiguration");
            Guard.AgainstDefault(messageProperty, "messageProperty");
        ...
        {
            Guard.AgainstDefault(sagaEntityProperty, "sagaEntityProperty");
