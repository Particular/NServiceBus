...
#pragma warning restore CS0618 // Type or member is obsolete
{
    ...
    public Task<StartableEndpoint> Create(IServiceProvider serviceProvider, bool forceRunInstallers, CancellationToken cancellationToken = default)
        => startupRunner.Create(serviceProvider, forceRunInstallers, cancellationToken);
