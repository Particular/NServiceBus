...
namespace NServiceBus
{
    ...
    public static partial class ConfigureLicenseExtensions
    {
        ...
        [ObsoleteEx(Replacement = "Configure.With(c=>c.License())", RemoveInVersion = "6.0", TreatAsErrorFromVersion = "5.0")]
        ...
        [ObsoleteEx(Replacement = "Configure.With(c=>c.LicensePath())", RemoveInVersion = "6.0", TreatAsErrorFromVersion = "5.0")]
