namespace NServiceBus
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// <param name="dependencyLifecycle">Defines lifecycle semantics for the given type.</param>
        [ObsoleteEx(
            Message = "'ServiceCollectionExtensions.ConfigureComponent<T>(IServiceCollection, DependencyLifecycle)' is obsolete: 'Use `IServiceCollection.Add`, `IServiceCollection.AddSingleton`, `IServiceCollection.AddTransient` or `IServiceCollection.AddScoped` instead.",
            TreatAsErrorFromVersion = "9.0",
            RemoveInVersion = "10.0")]
        ...
        /// <param name="dependencyLifecycle">Defines lifecycle semantics for the given type.</param>
        [ObsoleteEx(
            Message = "'ServiceCollectionExtensions.ConfigureComponent<T>(IServiceCollection, Func<T>, DependencyLifecycle)' is obsolete: 'Use `IServiceCollection.Add`, `IServiceCollection.AddSingleton`, `IServiceCollection.AddTransient` or `IServiceCollection.AddScoped` instead.",
            TreatAsErrorFromVersion = "9.0",
            RemoveInVersion = "10.0")]
        ...
        /// </summary>
        [ObsoleteEx(
            Message = "'ServiceCollectionExtensions.ConfigureComponent<T>(IServiceCollection, Func<IServiceProvider, T>, DependencyLifecycle)' is obsolete: 'Use `IServiceCollection.Add`, `IServiceCollection.AddSingleton`, `IServiceCollection.AddTransient` or `IServiceCollection.AddScoped` instead.",
            TreatAsErrorFromVersion = "9.0",
            RemoveInVersion = "10.0")]
        ...
        /// </summary>
        [ObsoleteEx(
            Message = "'ServiceCollectionExtensions.ConfigureComponent<T>(IServiceCollection, Type, object)' is obsolete: 'Use `IServiceCollection.Add`, `IServiceCollection.AddSingleton`, `IServiceCollection.AddTransient` or `IServiceCollection.AddScoped` instead.",
            TreatAsErrorFromVersion = "9.0",
            RemoveInVersion = "10.0")]
