...
sealed class SerializationFeature : Feature
{
    ...
    protected override void Setup(FeatureConfigurationContext context)
    {
        ...
        context.Pipeline.Register("DeserializeLogicalMessagesConnector", b => new DeserializeMessageConnector(resolver, logicalMessageFactory, messageMetadataRegistry, mapper, allowMessageTypeInference, b.GetRequiredService<PipelineMetrics>()), "Deserializes the physical message body into logical messages");
        context.Pipeline.Register("SerializeMessageConnector", b => new SerializeMessageConnector(mainSerializer, messageMetadataRegistry, b.GetRequiredService<PipelineMetrics>()), "Converts a logical message into a physical message");
