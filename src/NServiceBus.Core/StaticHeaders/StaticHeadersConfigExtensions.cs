namespace NServiceBus
{
    ...
    public static class StaticHeadersConfigExtensions
    {
        ...
        /// if you need to apply headers that needs to be dynamic per message. You can also set headers explicitly for a given message using any of the SendAsync/Reply or PublishOptions.
        /// </summary>
