namespace NServiceBus
{
    ...
    {
        public override async Task Invoke(IOutgoingReplyContext context, Func<IOutgoingLogicalMessageContext, CancellationToken, Task> stage, CancellationToken token)
        {
