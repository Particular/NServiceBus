namespace NServiceBus
{
    ...
    /// </summary>
    /// <param name="context">The current <see cref="IIncomingPhysicalMessageContext"/> of the subscription control message.</param>
    /// <returns><code>true</code> to allow the subscription to be stored; <code>false</code> to decline the subscription.</returns>
    public delegate bool SubscriptionAuthorizer(IIncomingPhysicalMessageContext context);
}