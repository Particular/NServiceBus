namespace NServiceBus.MessagingBestPractices
{
    ...
    class Validations
    {
        ...
        public void AssertIsValidForReply(Type messageType)
        {
            ...
            throw new Exception("ReplyAsync is neither supported for Commands nor Events. Commands should be sent to their logical owner using bus.Send and bus. Events should be Published with bus.PublishAsync.");
        }
