namespace NServiceBus.Config
{
    ...
    public class SecondLevelRetriesConfig : ConfigurationSection
    {
        ...
        public SecondLevelRetriesConfig()
        {
            ...
            Properties.Add(new ConfigurationProperty("TimeIncrease", typeof(TimeSpan), DefaultRecoverabilityPolicy.DefaultTimeIncrease, null, new TimeSpanValidator(TimeSpan.Zero, TimeSpan.MaxValue), ConfigurationPropertyOptions.None));
            Properties.Add(new ConfigurationProperty("NumberOfRetries", typeof(int), DefaultRecoverabilityPolicy.DefaultNumberOfRetries, null, new IntegerValidator(0, int.MaxValue), ConfigurationPropertyOptions.None));
        }
