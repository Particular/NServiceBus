namespace NServiceBus.Features
{
    ...
    public class FirstLevelRetries : Feature
    {
        internal FirstLevelRetries()
        {
            ...
            Prerequisite(context => context.Settings.GetRequiredTransactionSupportForReceives() > TransactionSupport.None, "FLR requires the transport to be able to rollback");
