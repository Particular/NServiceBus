namespace NServiceBus
{
    ...
    public class TransportExtensions : ExposeSettings
    {
        ...
        public TransportExtensions ConnectionString(string connectionString)
        {
            ...
            Settings.Get<TransportComponent.Settings>().TransportConnectionString = new TransportConnectionString(() => connectionString);
            return this;
        }
        ...
        public TransportExtensions ConnectionStringName(string name)
        {
            ...
            Settings.Get<TransportComponent.Settings>().TransportConnectionString = new TransportConnectionString(name);
            return this;
        }
#endif
