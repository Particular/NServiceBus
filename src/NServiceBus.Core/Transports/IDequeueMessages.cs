namespace NServiceBus.Transports
{
    ...
    public interface IDequeueMessages
    {
        ...
        void Init(string address, TransactionSettings transactionSettings, Func<TransportMessage, bool> tryProcessMessage, Action<TransportMessage, Exception> endProcessMessage);
