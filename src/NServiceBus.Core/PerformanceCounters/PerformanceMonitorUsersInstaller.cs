namespace NServiceBus
{
    ...
    {
        public PerformanceMonitorUsersInstaller(IConfigureComponents configureComponents, IBuilder builder)
        {
        ...
        {
            if(!configureComponents.HasComponent<Installer>())
            {
                return TaskEx.CompletedTask;
            }

            return builder.Build<Installer>().Install(identity);
        }
