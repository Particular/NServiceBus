namespace NServiceBus
{
    ...
    /// <summary>
    /// Extension methods for injecting props in <see cref="IHandleMessages{T}"/>, <see cref="IProcessCommands{T}"/> or <see cref="IProcessEvents{T}"/>.
    /// </summary>
    public static class ConfigureHandlerSettings
    {
        /// <summary>
        /// Initializes <see cref="IHandleMessages{T}"/>, <see cref="IProcessCommands{T}"/> or <see cref="IProcessEvents{T}"/> with the specified properties.
        /// </summary>
        /// <typeparam name="THandler">The <see cref="IHandleMessages{T}"/>, <see cref="IProcessCommands{T}"/> or <see cref="IProcessEvents{T}"/> type.</typeparam>
