namespace NServiceBus.Logging
{
    ...
    public interface ILog
    {
        ...
        /// <summary>
        /// Writes the message at the <see cref="LogLevel.Debug"/> level using the specified <paramref name="format"/> provider and format <paramref name="args"/>.
        /// </summary>
        ...
        /// <summary>
        /// Writes the message at the <see cref="LogLevel.Info"/> level using the specified <paramref name="format"/> provider and format <paramref name="args"/>.
        /// </summary>
        /// <param name="format">A string containing format items.</param>
        /// <param name="args">Arguments to format.</param>
        [StringFormatMethod("format")]
        ...
        /// <summary>
        /// Writes the message at the <see cref="LogLevel.Warn"/> level using the specified <paramref name="format"/> provider and format <paramref name="args"/>.
        /// </summary>
        /// <param name="format">A string containing format items.</param>
        /// <param name="args">Arguments to format.</param>
        [StringFormatMethod("format")]
        ...
        /// <summary>
        /// Writes the message at the <see cref="LogLevel.Error"/> level using the specified <paramref name="format"/> provider and format <paramref name="args"/>.
        /// </summary>
        /// <param name="format">A string containing format items.</param>
        /// <param name="args">Arguments to format.</param>
        [StringFormatMethod("format")]
        ...
        /// <summary>
        /// Writes the message at the <see cref="LogLevel.Fatal"/> level using the specified <paramref name="format"/> provider and format <paramref name="args"/>.
        /// </summary>
        /// <param name="format">A string containing format items.</param>
        /// <param name="args">Arguments to format.</param>
        [StringFormatMethod("format")]
