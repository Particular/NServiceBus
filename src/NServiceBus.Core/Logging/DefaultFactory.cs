...
/// </summary>
[ObsoleteMetadata(
    ReplacementTypeOrMember = "IServiceCollection.Configure<RollingLoggerProviderOptions>()",
    TreatAsErrorFromVersion = "11",
    RemoveInVersion = "12")]
[Obsolete("Use 'IServiceCollection.Configure<RollingLoggerProviderOptions>()' instead. Will be treated as an error from version 11.0.0. Will be removed in version 12.0.0.", false)]
public class DefaultFactory : LoggingFactoryDefinition
{
    ...
    public DefaultFactory()
    {
        directory = new Lazy<string>(() =>
        {
            ...
            {
                throw new Exception("Unable to determine the logging output directory. Check the inner exception for further information, or configure a custom logging directory using 'IServiceCollection.Configure<RollingLoggerProviderOptions>(o => o.Directory = \"...\")'.", e);
            }
        });
    ...
    /// </summary>
    [ObsoleteMetadata(
        Message = "Use 'RollingLoggerProviderOptions.LogLevel' instead. Note: NServiceBus.Logging.LogLevel.Info maps to Microsoft.Extensions.Logging.LogLevel.Information, Warn to Warning, Fatal to Critical",
        TreatAsErrorFromVersion = "11",
        RemoveInVersion = "12")]
    [Obsolete("Use 'RollingLoggerProviderOptions.LogLevel' instead. Note: NServiceBus.Logging.LogLevel.Info maps to Microsoft.Extensions.Logging.LogLevel.Information, Warn to Warning, Fatal to Critical. Will be treated as an error from version 11.0.0. Will be removed in version 12.0.0.", false)]
    ...
    /// </summary>
    [ObsoleteMetadata(
        ReplacementTypeOrMember = "RollingLoggerProviderOptions.Directory",
        TreatAsErrorFromVersion = "11",
        RemoveInVersion = "12")]
    [Obsolete("Use 'RollingLoggerProviderOptions.Directory' instead. Will be treated as an error from version 11.0.0. Will be removed in version 12.0.0.", false)]
