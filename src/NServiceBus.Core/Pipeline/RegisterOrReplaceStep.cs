...
sealed class RegisterOrReplaceStep
{
    ...
    public static RegisterOrReplaceStep Create(string stepId, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.Interfaces)] Type behaviorType, string? description = null, Func<IServiceProvider, IBehavior>? factoryMethod = null)
    {
