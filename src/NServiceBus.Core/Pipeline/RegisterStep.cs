namespace NServiceBus.Pipeline
{
    ...
    public abstract class RegisterStep
    {
        ...
        /// <summary>
        ///     Instructs the pipeline to register this step before the <paramref name="step" /> one. If the
        ///     <paramref name="step" /> does not exist, this condition is ignored.
        /// </summary>
        ...
        /// <summary>
        ///     Instructs the pipeline to register this step before the <paramref name="id" /> one. If the <paramref name="id" />
        ...
        /// <summary>
        ///     Instructs the pipeline to register this step after the <paramref name="step" /> one. If the
        ///     <paramref name="step" /> does not exist, this condition is ignored.
        /// </summary>
        ...
        /// <summary>
        ///     Instructs the pipeline to register this step after the <paramref name="id" /> one. If the <paramref name="id" />
        ///     does not exist, this condition is ignored.
        /// </summary>
