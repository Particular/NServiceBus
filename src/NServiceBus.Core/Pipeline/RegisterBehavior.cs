namespace NServiceBus.Pipeline
{
    ...
    public abstract class RegisterBehavior
    {
        ...
        /// </summary>
        /// <param name="stepId">The unique identifier for this <see cref="IBehavior{TContext}"/>.</param>
        ...
        {
            public DefaultRegisterBehavior(Type behavior, WellKnownStep stepId, string description)
