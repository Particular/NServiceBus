    ...
    class HardcodedPipelineSteps
    {
        ...
        public static void RegisterIncomingCoreBehaviors(PipelineSettings pipeline)
        {
            ...
            pipeline
                ...
                .Register("PrepareMessageContext", typeof(PrepareConsumeMessageContextBehavior), "If the current handler handles messages a handle context is added as invocation context.")
                .Register("PrepareEventContext", typeof(PrepareConsumeEventContextBehavior), "If the current handler handles events a subscribe context is added as invocation context.")
                .Register("PrepareTimeoutContext", typeof(PrepareConsumeTimoutContextBehavior), "If the current handler handles timeouts a timeout context is added as invocation context.")
