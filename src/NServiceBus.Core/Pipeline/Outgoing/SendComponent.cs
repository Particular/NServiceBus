namespace NServiceBus
{
    ...
    class SendComponent
    {
        ...
        public static SendComponent Initialize(PipelineSettings pipelineSettings, HostingComponent.Configuration hostingConfiguration, RoutingComponent routingComponent, IMessageMapper messageMapper)
        {
            ...
            pipelineSettings.Register("UnicastSendRouterConnector", sp => new SendConnector(routingComponent.UnicastSendRouterBuilder(sp)), "Determines how the message being sent should be routed");
            ...
            //TODO read configuration for dispatch span
            pipelineSettings.Register(new BatchToDispatchConnector(false), "Passes batched messages over to the immediate dispatch part of the pipeline");
