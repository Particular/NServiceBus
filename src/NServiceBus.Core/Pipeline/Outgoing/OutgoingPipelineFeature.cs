namespace NServiceBus.Features
{
    ...
    class OutgoingPipelineFeature : Feature
    {
        ...
        protected internal override void Setup(FeatureConfigurationContext context)
        {
            ...
            context.Pipeline.Register(new ImmediateDispatchTerminator(context.Transport.Dispatcher), "Hands the outgoing messages over to the transport for immediate delivery");
        }
    }
}