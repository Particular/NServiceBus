namespace NServiceBus
{
    ...
    public static class ScheduleBusExtensions
    {
        ...
        public static void ScheduleEvery(this ISendOnlyBus bus, TimeSpan timeSpan, Action task)
        {
        ...
        public static void ScheduleEvery(this ISendOnlyBus bus, TimeSpan timeSpan, string name, Action task)
        {
            Guard.AgainstNull(nameof(task), task);
        ...
        static void Schedule(TaskDefinition taskDefinition, ISendOnlyBus bus)
        {
            ...
            bus.SendAsync(new Scheduling.Messages.ScheduledTask
            {
