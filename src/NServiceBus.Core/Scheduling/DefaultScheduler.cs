namespace NServiceBus
{
    ...
    class DefaultScheduler
    {
        ...
        public async Task Start(Guid taskId, IScopedMessageSession context)
        {
        ...
        static async Task ExecuteTask(TaskDefinition taskDefinition, IScopedMessageSession context)
        {
        ...
        static Task DeferTask(TaskDefinition taskDefinition, IScopedMessageSession context)
        {
