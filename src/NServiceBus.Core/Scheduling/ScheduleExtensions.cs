namespace NServiceBus
{
    ...
    public static class ScheduleExtensions
    {
        ...
        public static Task ScheduleEvery(this IMessageSession session, TimeSpan timeSpan, Func<IScopedMessageSession, Task> task)
        {
        ...
        public static Task ScheduleEvery(this IMessageSession session, TimeSpan timeSpan, string name, Func<IScopedMessageSession, Task> task)
        {
            Guard.AgainstNull(nameof(task), task);
