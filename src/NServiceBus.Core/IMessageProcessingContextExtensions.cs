namespace NServiceBus
{
    ...
    public static class IMessageProcessingContextExtensions
    {
        ...
        /// </summary>
        /// <param name="context">The instance of <see cref="IMessageProcessingContext"/> to use for the action.</param>
        /// <param name="message">The message to send.</param>
        public static Task SendAsync(this IMessageProcessingContext context, object message)
        {
            Guard.AgainstNull(nameof(context), context);
            Guard.AgainstNull(nameof(message), message);
        ...
        /// </remarks>
        public static Task SendAsync<T>(this IMessageProcessingContext context, Action<T> messageConstructor)
        {
            Guard.AgainstNull(nameof(context), context);
            Guard.AgainstNull(nameof(messageConstructor), messageConstructor);
        ...
        /// <param name="message">The message to send.</param>
        public static Task SendAsync(this IMessageProcessingContext context, string destination, object message)
        {
            Guard.AgainstNull(nameof(context), context);
        ...
        /// <param name="messageConstructor">An action which initializes properties of the message.</param>
        public static Task SendAsync<T>(this IMessageProcessingContext context, string destination, Action<T> messageConstructor)
        {
            Guard.AgainstNull(nameof(context), context);
            Guard.AgainstNullAndEmpty(nameof(destination), destination);
            Guard.AgainstNull(nameof(messageConstructor), messageConstructor);
        ...
        /// <param name="context">Object being extended.</param>
        /// <param name="message">The message to send.</param>
        public static Task SendLocalAsync(this IMessageProcessingContext context, object message)
        {
            Guard.AgainstNull(nameof(context), context);
            Guard.AgainstNull(nameof(message), message);
        ...
        /// <param name="context">Object being extended.</param>
        /// <param name="messageConstructor">An action which initializes properties of the message.</param>
        public static Task SendLocalAsync<T>(this IMessageProcessingContext context, Action<T> messageConstructor)
        {
            Guard.AgainstNull(nameof(context), context);
            Guard.AgainstNull(nameof(messageConstructor), messageConstructor);
        ...
        public static Task PublishAsync(this IMessageProcessingContext context, object message)
        {
        ...
        public static Task PublishAsync<T>(this IMessageProcessingContext context)
        {
        ...
        /// <param name="context">The instance of <see cref="IMessageProcessingContext"/> to use for the action.</param>
        /// <param name="messageConstructor">An action which initializes properties of the message.</param>
        public static Task PublishAsync<T>(this IMessageProcessingContext context, Action<T> messageConstructor)
        {
