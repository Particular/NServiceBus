...
partial class ReceiveComponent
{
        ...
        PipelineSettings pipelineSettings)
    {
        ...
        pipelineSettings.Register("InvokeHandlers", new InvokeHandlerTerminator(hostingConfiguration.ActivityFactory, provider => provider.GetService<IncomingPipelineMetrics>()), "Calls the IHandleMessages<T>.Handle(T)");
