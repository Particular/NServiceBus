...
partial class ReceiveComponent
{
        ...
        PipelineSettings pipelineSettings)
    {
        ...
        pipelineSettings.Register("InvokeHandlers", new InvokeHandlerTerminator(hostingConfiguration.ActivityFactory, hostingConfiguration.HandlingMetricsFactory), "Calls the IHandleMessages<T>.Handle(T)");
