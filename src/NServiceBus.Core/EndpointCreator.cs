...
class EndpointCreator
{
    ...
    void Configure()
    {
        ...
        pipelineComponent = PipelineComponent.Initialize(pipelineSettings, hostingConfiguration, receiveConfiguration, settings.GetOrCreate<PerformanceMetricsOptions>());
