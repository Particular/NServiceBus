namespace NServiceBus.Features
{
    ...
    public class FeatureConfigurationContext
    {
        ...
        /// <param name="onMessage">Called when a message is available for processing.</param>
        /// <param name="onError">Called when processing failed.</param>
        /// <param name="transportAddress">The autogenerated transport address to listen on.</param>
        public void AddSatelliteReceiver(string name,
            string transportAddress,
            TransportTransactionMode requiredTransportTransactionMode,
        ...
        {
            var satelliteDefinition = new SatelliteDefinition(name, transportAddress, requiredTransportTransactionMode, runtimeSettings, onMessage, onError);
