namespace NServiceBus.Features
{
    ...
    public class FeatureConfigurationContext
    {
        ...
        public void AddSatelliteReceiver(string name, TransportTransactionMode requiredTransportTransactionMode, PushRuntimeSettings runtimeSettings, string qualifier,Func<PushContext,Task> onMessage, out string transportAddress)
        {
