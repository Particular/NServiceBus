namespace NServiceBus.Features
{
    ...
    class FeatureActivator
    {
        ...
        public FeatureDiagnosticsData[] SetupFeatures(IConfigureComponents container, PipelineSettings pipelineSettings, RoutingComponent routing, ReceiveComponent receiving = null)
        {
            ...
            {
                ActivateFeature(feature, enabledFeatures, container, pipelineSettings, routing, receiving);
            }
        ...
        bool ActivateFeature(FeatureInfo featureInfo, List<FeatureInfo> featuresToActivate, IConfigureComponents container, PipelineSettings pipelineSettings, RoutingComponent routing, ReceiveComponent receiving)
        {
            ...
            Func<List<string>, bool> dependencyActivator = dependencies =>
            {
                ...
                return dependentFeaturesToActivate.Aggregate(false, (current, f) => current | ActivateFeature(f, featuresToActivate, container, pipelineSettings, routing, receiving));
            };
            ...
            if (featureInfo.Feature.Dependencies.All(dependencyActivator))
            {
                ...
                var context = new FeatureConfigurationContext(settings, container, pipelineSettings, routing, receiving);
