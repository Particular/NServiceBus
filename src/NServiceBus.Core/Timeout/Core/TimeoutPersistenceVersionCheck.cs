namespace NServiceBus.Timeout.Core
{
    ...
    internal class TimeoutPersistenceVersionCheck : IWantToRunWhenConfigurationIsComplete
    {
        ...
        public void Run()
        {
            ...
            throw new Exception("You are using an outdated timeout persistence which can lead to message loss! Please update the configured timeout persistence. You can suppress this warning by configuring your bus using 'config.SuppressOutdatedTimeoutPersistenceWarning()' or by adding 'suppress-outdated-timeout-persistence-warning' with value 'true' to the appSettings section of your application configuration file.");
        }
