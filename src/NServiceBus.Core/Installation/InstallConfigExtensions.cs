...
public static class InstallConfigExtensions
{
    ...
    /// </summary>
    public static void AddInstaller<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TInstaller>(this EndpointConfiguration config) where TInstaller : class, INeedToInstallSomething
    {
        ArgumentNullException.ThrowIfNull(config);
    ...
    /// Adds the installer type.
    /// </summary>
    public static void AddInstaller<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TInstaller>(this FeatureConfigurationContext context) where TInstaller : class, INeedToInstallSomething
    {
