namespace NServiceBus.Config
{
    ...
    /// </summary>
    [ObsoleteEx(Message = "Use the feature concept instead.", RemoveInVersion = "7", TreatAsErrorFromVersion = "6", Replacement = "A class which inherits from NServiceBus.Features.Feature and use configuration.EnableFeature<YourClass>()")]
