...
namespace NServiceBus.Utils
{
    ...
    public class MsmqUtilities
    {
        ...
        /// <returns></returns>
        [ObsoleteEx(Replacement = "MsmqUtilities.GetFullPath(Address)", TreatAsErrorFromVersion = "0.0")]
        ...
        /// <returns></returns>
        [ObsoleteEx(Replacement = "Address.Machine",TreatAsErrorFromVersion = "0.0")]
        ...
        /// <param name="logicalName"></param>
        /// <returns></returns>
        [ObsoleteEx(Replacement = "Address.Queue", TreatAsErrorFromVersion = "0.0")]
