...
// Consider validating against a select set of downstream persistence repositories before shipping.

[TestFixture]
public class PersistenceTestsShippedSourceFilesApproval
{
    [Test]
