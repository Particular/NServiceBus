namespace NServiceBus.AcceptanceTests.Sagas
{
    ...
    public class When_a_existing_saga_instance_exists_new : NServiceBusAcceptanceTest
    {
        ...
        public class SagaEndpoint : EndpointConfigurationBuilder
        {
            ...
            public class TestSaga : Saga<TestSagaData>, IAmStartedByCommands<StartSagaMessage>
            {
