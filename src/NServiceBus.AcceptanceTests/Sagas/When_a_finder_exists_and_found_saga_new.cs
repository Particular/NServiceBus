namespace NServiceBus.AcceptanceTests.Sagas
{
    ...
    [TestFixture]
    public class When_a_finder_exists_and_found_saga_new
    {
        [Test]
        ...
        public class SagaEndpoint : EndpointConfigurationBuilder
        {
            ...
            public class TestSaga : Saga<TestSaga.SagaData>,
                IAmStartedByCommands<StartSagaMessage>,
                IProcessCommands<SomeOtherMessage>
            {
                public Context Context { get; set; }
                ...
                public void Handle(SomeOtherMessage message, ICommandContext context)
                {
