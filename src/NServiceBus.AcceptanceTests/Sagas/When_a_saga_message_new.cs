namespace NServiceBus.AcceptanceTests.Sagas
{
    ...
    public class When_a_saga_message_goes_through_the_slr_new : NServiceBusAcceptanceTest
    {
        [Test]
        ...
        public class SagaEndpoint : EndpointConfigurationBuilder
        {
            ...
            public class TestSaga : Saga<TestSagaData>, IAmStartedByCommands<StartSagaMessage>, IProcessCommands<SecondSagaMessage>
            {
                public Context Context { get; set; }
                public void Handle(StartSagaMessage message, ICommandContext context)
                {
                ...
                public void Handle(SecondSagaMessage message, ICommandContext context)
                {
