namespace NServiceBus.AcceptanceTests.Sagas
{
    ...
    public class When_endpoint_replies_to_a_saga_new : NServiceBusAcceptanceTest
    {
        [Test]
        ...
        public class EndpointThatHandlesAMessageFromSagaAndReplies : EndpointConfigurationBuilder
        {
            ...
            class DoSomethingHandler : IProcessCommands<DoSomething>
            {
                public void Handle(DoSomething message, ICommandContext context)
                {
                    context.Reply(new DoSomethingResponse { RunId = message.RunId });
                }
            }
        }
        ...
        public class EndpointThatHostsASaga : EndpointConfigurationBuilder
        {
            ...
            public class Saga2 : Saga<Saga2.MySaga2Data>, IAmStartedByCommands<StartSaga>, IProcessResponses<DoSomethingResponse>
            {
                public Context Context { get; set; }
                ...
                public void Handle(StartSaga message, ICommandContext context)
                {
                    ...
                    context.Send(new DoSomething { RunId = message.RunId });
                }

                public void Handle(DoSomethingResponse message, IResponseContext context)
                {
                    Context.Done = true;
