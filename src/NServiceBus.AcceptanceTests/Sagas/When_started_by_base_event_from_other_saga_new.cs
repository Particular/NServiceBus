namespace NServiceBus.AcceptanceTests.Sagas
{
    ...
    //Repro for #1323
    public class When_started_by_base_event_from_other_saga_new : NServiceBusAcceptanceTest
    {
        [Test]
        ...
        public class SagaThatIsStartedByABaseEvent : EndpointConfigurationBuilder
        {
            ...
            public class SagaStartedByBaseEvent : Saga<SagaStartedByBaseEvent.SagaData>, IAmStartedByEvents<BaseEvent>
            {
                public SagaContext Context { get; set; }

                public void Handle(BaseEvent message, IEventContext context)
                {
                    MarkAsComplete();
