...
#pragma warning restore IDE0079
                    ...
                    Assert.Throws<InvalidOperationException>(() => context.Settings.LocalQueueAddress(), "Should throw since the endpoint is send only");
                    Assert.Throws<InvalidOperationException>(() => context.Settings.InstanceSpecificQueueAddress(), "Should throw since the endpoint is send only");
