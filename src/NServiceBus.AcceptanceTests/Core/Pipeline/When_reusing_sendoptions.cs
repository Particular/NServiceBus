...
public class When_reusing_sendoptions : NServiceBusAcceptanceTest
{
    ...
    {
        public ConcurrentQueue<string> ReceivedMessageIds = [];

        public void MaybeComplete() => MarkAsCompleted(ReceivedMessageIds.Count >= 3);
    }
    ...
    class Endpoint : EndpointConfigurationBuilder
    {
        ...
        class CommandHandler(When_reusing_sendoptions.Context testContext) : IHandleMessages<SomeCommand>
        {
