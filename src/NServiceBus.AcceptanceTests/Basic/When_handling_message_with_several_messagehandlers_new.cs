namespace NServiceBus.AcceptanceTests.Basic
{
    ...
    public class When_handling_message_with_several_messagehandlers_new : NServiceBusAcceptanceTest
    {
        [Test]
        ...
        public class FirstMessageHandler : IProcessCommands<MyMessage>
        {
        ...
        public class SecondMessageHandler : IProcessCommands<MyMessage>
        {
            public Context Context { get; set; }
