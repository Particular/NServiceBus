namespace NServiceBus.AcceptanceTests.Basic
{
    ...
    public class When_multiple_mappings_exists_new : NServiceBusAcceptanceTest
    {
        [Test]
        ...
        public class Receiver1 : EndpointConfigurationBuilder
        {
            ...
            public class MyMessageHandler : IProcessCommands<MyBaseCommand>
            {
                public Context Context { get; set; }

                public IBus Bus { get; set; }

                public void Handle(MyBaseCommand message, ICommandContext context)
                {
                    Context.WasCalled1 = true;
                    // TODO: Is there a clever way?
