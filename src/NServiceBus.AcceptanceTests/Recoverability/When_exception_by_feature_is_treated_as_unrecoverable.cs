namespace NServiceBus.AcceptanceTests.Recoverability
{
    ...
    public class When_exception_by_feature_is_treated_as_unrecoverable : NServiceBusAcceptanceTest
    {
        [Test]
        ...
        class EndpointWithFailingHandler : EndpointConfigurationBuilder
        {
            ...
            class MyCustomFeature : Feature
            {
                ...
                {
                    Defaults(s => s.AddUnrecoverableException(typeof(SimulatedException)));
                    EnableByDefault();
                }
