namespace NServiceBus.AcceptanceTests.HandlerContext
{
    ...
    public class When_replying_to_handlers_with_old_and_new_api_with_order_override : NServiceBusAcceptanceTest
    {
        [Test]
        ...
        static class Verify
        {
            ...
            {
                Assert.AreEqual("OldStyle", context.HandlersExecuted[2]);
            }
        ...
        public class Sender : EndpointConfigurationBuilder
        {
            ...
            public class Order : ISpecifyMessageHandlerOrdering
            {
                public void SpecifyOrder(global::NServiceBus.Order order)
                {
                    order.SpecifyFirst<NewHandlerApi>();
                }
            }
