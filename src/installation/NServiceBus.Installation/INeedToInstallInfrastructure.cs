namespace NServiceBus.Installation
{
    ...
    /// </summary>
    [ObsoleteEx(Message = "It is possible to use NServiceBus installer or powershell support to accomplish the same thing. Please see http://www.nservicebus.com/powershell.aspx for more information.", TreatAsErrorFromVersion = "4.0", RemoveInVersion = "5.0")]
