...
namespace NServiceBus.Hosting.Azure.HostProcess
{
    ...
    public class WindowsHost : MarshalByRefObject
    {
        ...
        public WindowsHost(Type endpointType, string[] args)
        {
            ...
            genericHost = new GenericHost(specifier, args, new List<Type> { typeof(Development), typeof(OnAzureTableStorage), typeof(WithAzureStorageQueues) }, Program.EndpointId);
        }
