namespace NServiceBus
{
    ...
    public static class MessageConventionExtensions
    {
        ...
        static ConventionCache messagesConventionCache = new ConventionCache();
        static ConventionCache commandsConventionCache = new ConventionCache();
        static ConventionCache eventsConventionCache = new ConventionCache();

    }

    class ConventionCache
    {
        readonly IDictionary<Type,bool> cache = new ConcurrentDictionary<Type,bool>();
