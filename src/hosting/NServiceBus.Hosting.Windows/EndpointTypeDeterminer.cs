namespace NServiceBus.Hosting.Windows
{
    ...
    public class EndpointTypeDeterminer
    {
        ...
        public EndpointTypeDeterminer(AssemblyScannerResults assemblyScannerResults, Func<string> getEndpointConfigurationTypeFromConfig ) {
        ...
        bool TryGetEndpointConfigurationTypeFromArguments(HostArguments arguments, out Type type) {
            ...
            if (endpointType == null) {
                throw new ConfigurationErrorsException(string.Format("Command line argument 'endpointConfigurationType' has specified to use the type '{0}' but that type could not be loaded.", arguments.EndpointConfigurationType));
            }
            type = endpointType;
            return true;
        }
