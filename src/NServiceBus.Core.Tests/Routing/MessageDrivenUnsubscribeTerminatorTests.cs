namespace NServiceBus.Core.Tests.Routing
{
    ...
    public class MessageDrivenUnsubscribeTerminatorTests
    {
        ...
        public void SetUp()
        {
            ...
            terminator = new MessageDrivenUnsubscribeTerminator(router, "replyToAddress", new TransportDispatcher(dispatcher, new List<Tuple<IDispatchMessages, TransportDefinition>>()));
        }
