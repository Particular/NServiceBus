namespace NServiceBus.Core.Tests.Msmq
{
    ...
    public class TimeToBeRceivedOverrideCheckerTest
    {
        ...
        public void Should_not_throw_on_non_Msmq()
        {
            Assert.DoesNotThrow(() =>
            {
                TimeToBeRceivedOverrideChecker.Check(usingMsmq: false, isTransactional: false, outBoxRunning: false, auditTTBROverridden: false, forwardTTBROverridden: false);
            });
        }
        ...
        public void Should_not_throw_on_non_transactional()
        {
            Assert.DoesNotThrow(() =>
            {
                TimeToBeRceivedOverrideChecker.Check(usingMsmq: true, isTransactional: false, outBoxRunning: false, auditTTBROverridden: false, forwardTTBROverridden: false);
            });
        }
        ...
        public void Should_throw_on_overridden_audit_TimeToBeReceived()
        {
            ...
            {
                TimeToBeRceivedOverrideChecker.Check(usingMsmq: true, isTransactional: true, outBoxRunning: false, auditTTBROverridden: true, forwardTTBROverridden: false);
            });
        ...
        public void Should_throw_on_overridden_TimeToBeReceivedOnForwardedMessages()
        {
            var exception = Assert.Throws<Exception>(() =>
            {
                TimeToBeRceivedOverrideChecker.Check(usingMsmq: true, isTransactional: true, outBoxRunning: false, auditTTBROverridden: false, forwardTTBROverridden: true);
            });
