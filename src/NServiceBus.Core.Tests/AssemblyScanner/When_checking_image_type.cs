namespace NServiceBus.Core.Tests.AssemblyScanner
{
    ...
    public class When_checking_image_type
    {
        ...
        {
            var file = Path.Combine(TestContext.CurrentContext.TestDirectory, "TestDlls", "ImageFormat", "RoslynX86.dll");
        ...
        {
            var file = Path.Combine(TestContext.CurrentContext.TestDirectory, "TestDlls", "ImageFormat", "RoslynX64.dll");
