namespace NServiceBus.Unicast.Tests
{
    ...
    public class UnicastBusAuthorizationTests
    {
        ...
        {
            var authorizationType = ConfigUnicastBus.FindAuthorizationType(new List<Type>());
        ...
        {
            var exception = Assert.Throws<Exception>(() => ConfigUnicastBus.FindAuthorizationType(new List<Type>()
            {
                typeof(Authorizer1),
                typeof(Authorizer2)
            }));
