    ...
    public class ExceptionTests
    {
        ...
        public void VerifyExceptionConventions()
        {
            ...
            foreach (var exceptionType in exceptionTypes)
            {
                ...
                Assert.IsNotNull(constructor, string.Format("Exception '{0}' should implement 'ctor(SerializationInfo info, StreamingContext context)'", exceptionType.Name));
                ...
                var propertyInfos = exceptionType.GetProperties(BindingFlags.Public|BindingFlags.Instance);
