namespace NServiceBus.Core.Tests.Pipeline.Incoming
{
    ...
    {
        [Test]
        public async Task When_processing_message_without_enclosed_message_type_header_it_is_added()
        {
            ...
            await behavior.Invoke(context, messageContext => TaskEx.CompletedTask);
        ...
        [Test]
        public async Task When_processing_message_with_enclosed_message_type_header_it_is_not_changed()
        {
            ...
            await mutator.Invoke(context, messageContext => TaskEx.CompletedTask);
