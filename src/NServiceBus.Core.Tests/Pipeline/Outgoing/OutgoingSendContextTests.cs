namespace NServiceBus.Core.Tests.Pipeline.Outgoing
{
    ...
    public class OutgoingSendContextTests
    {
        ...
        public void ShouldShallowCloneContext()
        {
            ...
            var testee = new OutgoingSendContext(message, "message-id", options.OutgoingHeaders, options, new FakeRootContext());
        ...
        public void ShouldNotMergeOptionsToParentContext()
        {
            ...
            new OutgoingSendContext(message, "message-id", options.OutgoingHeaders, options, parentContext);
