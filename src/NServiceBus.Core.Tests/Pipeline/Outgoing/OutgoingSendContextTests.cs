...
public class OutgoingSendContextTests
{
    ...
    public void ShouldExposeSendOptionsExtensionsAsOperationProperties()
    {
        ...
        var context = new OutgoingSendContext(message, "message-id", [], options, parentContext);
    ...
    public void ShouldNotLeakParentsOperationProperties()
    {
        ...
        var parentContext = new OutgoingSendContext(new OutgoingLogicalMessage(typeof(object), new object()), "message-id", [], outerOptions, new FakeRootContext());
