namespace NServiceBus.Core.Tests.Audit
{
    ...
    public class AttachCausationHeadersBehaviorTests
    {
        ...
        public void Should_set_the_conversation_id_to_new_guid_when_not_sent_from_handler()
        {
            ...
            var context = new PhysicalOutgoingContextStageBehavior.Context(null, new OutgoingContext(null, null, null, new Dictionary<string, string>(), null));
        ...
        public void Should_not_override_a_conversation_id_specified_by_the_user()
        {
            ...
            var behavior = new AttachCausationHeadersBehavior();
            var context = new PhysicalOutgoingContextStageBehavior.Context(null,new OutgoingContext(null,null, null, new Dictionary<string, string> { { Headers.ConversationId, userConvId } },null));
