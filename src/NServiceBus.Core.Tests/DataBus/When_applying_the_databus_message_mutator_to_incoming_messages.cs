    ...
    class When_applying_the_databus_message_mutator_to_incoming_messages
    {
        ...
        public async Task Incoming_databus_properties_should_be_hydrated()
        {
            ...
            using (var stream = new MemoryStream())
            {
                ...
                await receiveBehavior.Invoke(new LogicalMessageProcessingStageBehavior.Context(message,new Dictionary<string, string> { { "NServiceBus.DataBus." + propertyKey, databusKey } },null), () => Task.FromResult(0));
            }
