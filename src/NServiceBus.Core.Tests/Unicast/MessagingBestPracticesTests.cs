    ...
    public class MessagingBestPracticesTests
    {
        ...
        public class When_replying
        {
            ...
            public void Should_throw_for_command()
            {
                ...
                Assert.AreEqual("ReplyAsync is neither supported for Commands nor Events. Commands should be sent to their logical owner using bus.Send and bus. Events should be Published with bus.PublishAsync.", invalidOperationException.Message);
            }
