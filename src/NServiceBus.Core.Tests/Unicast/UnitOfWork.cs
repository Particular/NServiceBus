namespace NServiceBus.Unicast.Tests
{
    ...
    [TestFixture]
    class When_processing_a_subscribe_message_successfully : using_the_unicastBus
    {
        [Test]
    ...
    [TestFixture]
    class When_begin_and_end_executes : using_the_unicastBus
    {
        [Test]
    ...
    [TestFixture]
    class When_a_uow_end_throws : using_the_unicastBus
    {
        [Test]
    ...
    [TestFixture]
    class When_a_uow_begin_throws : using_the_unicastBus
    {
        [Test]
    ...
    [TestFixture]
    class When_processing_a_message_successfully : using_the_unicastBus
    {
        [Test]
        public void Should_invoke_the_uow_begin_and_end()
        {
    ...
    [TestFixture]
    class When_processing_a_message_fails : using_the_unicastBus
    {
        [Test]
