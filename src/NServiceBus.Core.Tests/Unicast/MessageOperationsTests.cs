namespace NServiceBus.Unicast.Tests
{
    ...
    public class MessageOperationsTests
    {
        ...
        public void When_sending_message_interface_should_set_interface_as_message_type()
        {
            ...
            messageOperations.Send<IMyMessage>(new RootContext(null, messageOperations, null), m => { }, new SendOptions());
        ...
        public void When_sending_message_class_should_set_class_as_message_type()
        {
            ...
            messageOperations.Send<MyMessage>(new RootContext(null, messageOperations, null), m => { }, new SendOptions());
        ...
        public void When_sending_with_user_defined_message_id_should_set_defined_id_and_header()
        {
            ...
            messageOperations.Send<MyMessage>(new RootContext(null, messageOperations, null), m => { }, sendOptions);
        ...
        public void When_replying_message_interface_should_set_interface_as_message_type()
        {
            ...
            messageOperations.Reply<IMyMessage>(new RootContext(null, messageOperations, null), m => { }, new ReplyOptions());
        ...
        public void When_replying_message_class_should_set_class_as_message_type()
        {
            ...
            messageOperations.Reply<MyMessage>(new RootContext(null, messageOperations, null), m => { }, new ReplyOptions());
        ...
        public void When_replying_with_user_defined_message_id_should_set_defined_id_and_header()
        {
            ...
            messageOperations.Reply<MyMessage>(new RootContext(null, messageOperations, null), m => { }, replyOptions);
        ...
        public void When_publishing_event_interface_should_set_interface_as_message_type()
        {
            ...
            messageOperations.Publish<IMyMessage>(new RootContext(null, messageOperations, null), m => { }, new PublishOptions());
        ...
        public void When_publishing_event_class_should_set_class_as_message_type()
        {
            ...
            messageOperations.Publish<MyMessage>(new RootContext(null, messageOperations, null), m => { }, new PublishOptions());
        ...
        public void When_publishing_with_user_defined_message_id_should_set_defined_id_and_header()
        {
            ...
            messageOperations.Publish<MyMessage>(new RootContext(null, messageOperations, null), m => { }, publishOptions);
