namespace NServiceBus.Unicast.Tests
{
    ...
    public class MessageOperationsTests
    {
        ...
        [Test]
        public async Task When_sending_message_interface_should_set_interface_as_message_type()
        {
        ...
        [Test]
        public async Task When_sending_message_class_should_set_class_as_message_type()
        {
            var sendPipeline = new FakePipeline<IOutgoingSendContext>();
            var messageOperations = CreateMessageOperations(sendPipeline: sendPipeline);
        ...
        [Test]
        public async Task When_sending_should_generate_message_id_and_set_message_id_header()
        {
            var sendPipeline = new FakePipeline<IOutgoingSendContext>();
            var messageOperations = CreateMessageOperations(sendPipeline: sendPipeline);
        ...
        [Test]
        public async Task When_sending_with_user_defined_message_id_should_set_defined_id_and_header()
        {
        ...
        [Test]
        public async Task When_sending_should_clone_headers()
        {
            var sendPipeline = new FakePipeline<IOutgoingSendContext>();
            var messageOperations = CreateMessageOperations(sendPipeline: sendPipeline);
        ...
        [Test]
        public async Task When_replying_message_interface_should_set_interface_as_message_type()
        {
        ...
        [Test]
        public async Task When_replying_message_class_should_set_class_as_message_type()
        {
            var replyPipeline = new FakePipeline<IOutgoingReplyContext>();
            var messageOperations = CreateMessageOperations(replyPipeline: replyPipeline);
        ...
        [Test]
        public async Task When_replying_should_generate_message_id_and_set_message_id_header()
        {
            var replyPipeline = new FakePipeline<IOutgoingReplyContext>();
            var messageOperations = CreateMessageOperations(replyPipeline: replyPipeline);
        ...
        [Test]
        public async Task When_replying_with_user_defined_message_id_should_set_defined_id_and_header()
        {
            const string expectedMessageID = "expected message id";
        ...
        [Test]
        public async Task When_replying_should_clone_headers()
        {
            var replyPipeline = new FakePipeline<IOutgoingReplyContext>();
            var messageOperations = CreateMessageOperations(replyPipeline: replyPipeline);
        ...
        [Test]
        public async Task When_publishing_event_interface_should_set_interface_as_message_type()
        {
        ...
        [Test]
        public async Task When_publishing_event_class_should_set_class_as_message_type()
        {
            var publishPipeline = new FakePipeline<IOutgoingPublishContext>();
            var messageOperations = CreateMessageOperations(publishPipeline: publishPipeline);
        ...
        [Test]
        public async Task When_publishing_should_generate_message_id_and_set_message_id_header()
        {
            var publishPipeline = new FakePipeline<IOutgoingPublishContext>();
            var messageOperations = CreateMessageOperations(publishPipeline: publishPipeline);
        ...
        [Test]
        public async Task When_publishing_with_user_defined_message_id_should_set_defined_id_and_header()
        {
            const string expectedMessageID = "expected message id";
