...
namespace NServiceBus
{
    ...
    public interface ISendOnlyBus : System.IDisposable
    {
        ...
        NServiceBus.ICallback Send(object message, NServiceBus.SendContext context);
        NServiceBus.ICallback Send<T>(System.Action<T> messageConstructor);
        NServiceBus.ICallback Send<T>(System.Action<T> messageConstructor, NServiceBus.SendContext context);
    ...
    {
        public SendContext() { }
        public void DelayDeliveryWith(System.TimeSpan within) { }
        public void DeliverAt(System.DateTime at) { }
...
namespace NServiceBus.Pipeline.Contexts
{
    ...
    public abstract class LogicalMessageProcessingStageBehavior : NServiceBus.Pipeline.Behavior<NServiceBus.Pipeline.Contexts.LogicalMessageProcessingStageBehavior.Context>
    {
        ...
        {
            public Context(NServiceBus.Unicast.Messages.LogicalMessage logicalMessage, System.Collections.Generic.Dictionary<string, string> headers, NServiceBus.Pipeline.Contexts.LogicalMessagesProcessingStageBehavior.Context parentContext) { }
            protected Context(NServiceBus.Pipeline.BehaviorContext parentContext) { }
            public System.Collections.Generic.Dictionary<string, string> Headers { get; }
    ...
    {
        public OutgoingContext(NServiceBus.Pipeline.BehaviorContext parentContext, NServiceBus.Unicast.DeliveryOptions deliveryOptions, NServiceBus.Unicast.Messages.LogicalMessage message, System.Collections.Generic.Dictionary<string, string> headers) { }
    ...
    public abstract class PhysicalOutgoingContextStageBehavior : NServiceBus.Pipeline.Behavior<NServiceBus.Pipeline.Contexts.PhysicalOutgoingContextStageBehavior.Context>
    {
        ...
        {
            public Context(NServiceBus.Pipeline.Contexts.OutgoingContext parentContext) { }
            public byte[] Body { get; set; }
        }
    }
...
namespace NServiceBus.Unicast
{
    ...
    public class UnicastBus : NServiceBus.IBus, NServiceBus.ISendOnlyBus, NServiceBus.IStartableBus, NServiceBus.Unicast.IRealBus, System.IDisposable
    {
        ...
        public NServiceBus.ICallback Send(object message, NServiceBus.SendContext context) { }
        public NServiceBus.ICallback Send<T>(System.Action<T> messageConstructor) { }
        public NServiceBus.ICallback Send<T>(System.Action<T> messageConstructor, NServiceBus.SendContext context) { }
