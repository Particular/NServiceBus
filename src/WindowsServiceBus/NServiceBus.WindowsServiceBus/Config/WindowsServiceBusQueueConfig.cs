namespace NServiceBus.Config
{
	...
	public class WindowsServiceBusQueueConfig : ConfigurationSection
	{
		...
		//[ConfigurationProperty( "IssuerName", IsRequired = false, DefaultValue = WindowsServicebusDefaults.DefaultIssuerName )]
		...
		//[ConfigurationProperty( "ConnectionString", IsRequired = false, DefaultValue = WindowsServicebusDefaults.DefaultConnectionString )]
