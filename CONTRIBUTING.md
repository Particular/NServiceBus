...
* Avoid LINQ.
* Avoid using foreach over collections that do not have a struct enumerator. For public facing interfaces we favour readonly collections and enumerables. For internal types we favour speed and allocation reduction, therefore avoid using collection interfaces internally.
